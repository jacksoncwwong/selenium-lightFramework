...
public class TestMethodListener implements ITestListener, ISuiteListener, IInvokedMethodListener {
  ...
  public void onStart(ISuite suite) {
    BaseTest.writeData(
        SharedInfo.testName,
        "",
        "Begin executing Suite: " + suite.getName());
  }
  ...
  public void onFinish(ISuite suite) {
    BaseTest.writeData(
        SharedInfo.testName,
        "",
        "After executing Suite: " + suite.getName());
  }
  ...
  public void onStart(ITestContext arg0) {
    BaseTest.writeData(
        SharedInfo.testName,
        "",
        "Begin executing Test: " + arg0.getName());
  }
...
//  BaseTest.writeData(SharedInfo.testName, "fail", "Test Context: " + arg0.getTestContext());
    ...
    BaseTest.writeData(
        SharedInfo.testName,
        "fail",
        "Test Throwable: " + stackTraceString);
  }
...
//  BaseTest.writeData(SharedInfo.testName, "skipped", "Test Context: " + arg0.getTestContext());
  ...
  public void beforeInvocation(IInvokedMethod arg0, ITestResult arg1) {
    BaseTest.writeData(
        "",
        "",
        "Before Invocation of method: " + arg0.getTestMethod().getMethodName());
  }
  ...
  public void afterInvocation(IInvokedMethod arg0, ITestResult arg1) {
    BaseTest.writeData(
        SharedInfo.testName,
        "",
        "After Invocation of method: " + arg0.getTestMethod().getMethodName());
  }
  ...
  public void onTestFailedButWithinSuccessPercentage(ITestResult result) {
    BaseTest.writeData(
        SharedInfo.testName,
        "within percentage",
        "onTestFailedButWithinSuccessPercentage: " + result.getTestName());

    BaseTest.writeData(
        SharedInfo.testName,
        "within percentage",
        "Test Status: " + result.getName());
